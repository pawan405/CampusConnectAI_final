...
export default function AICareerRoadmap() {
  ...
  const getAiSummary = () => {
    ...
    const progress = "You've successfully mastered the core foundations and are now operating at a Level 4 competency. ";
    ...
    const positive = "Your consistency in hackathon participation is your greatest multiplier. ";
          ...
          <AnimatePresence mode="wait">
            {activeTab === "overview" ? (
              ...
              >
                        ...
                        <div className="space-y-6">
                          <div className="space-y-2">
                            ...
                            <Select>
                              ...
                              <SelectContent className="bg-white border-white/10 text-black">
                                <SelectItem className="text-black focus:bg-gray-100 focus:text-black" value="1">1st Year</SelectItem>
                                <SelectItem className="text-black focus:bg-gray-100 focus:text-black" value="2">2nd Year</SelectItem>
                                <SelectItem className="text-black focus:bg-gray-100 focus:text-black" value="3">3rd Year</SelectItem>
                                <SelectItem className="text-black focus:bg-gray-100 focus:text-black" value="4">4th Year</SelectItem>
                              </SelectContent>
                            </Select>
                          </div>
                          ...
                          <div className="space-y-2">
                            ...
                            <Select onValueChange={setDiscipline}>
                              ...
                              <SelectContent className="bg-white border-white/10 text-black">
                                <SelectItem className="text-black focus:bg-gray-100 focus:text-black" value="cse">CS Engineering</SelectItem>
                                <SelectItem className="text-black focus:bg-gray-100 focus:text-black" value="ece">Electronics</SelectItem>
                                <SelectItem className="text-black focus:bg-gray-100 focus:text-black" value="me">Mechanical</SelectItem>
                              </SelectContent>
                            </Select>
                          </div>
                          ...
                          <div className="space-y-2">
                            ...
                            <Select onValueChange={setIntent}>
                              ...
                              <SelectContent className="bg-white border-white/10 text-black">
                                <SelectItem className="text-black focus:bg-gray-100 focus:text-black" value="web">Fullstack Web</SelectItem>
                                <SelectItem className="text-black focus:bg-gray-100 focus:text-black" value="ai">AI / ML Engineer</SelectItem>
                                <SelectItem className="text-black focus:bg-gray-100 focus:text-black" value="data">Data Scientist</SelectItem>
                              </SelectContent>
                            </Select>
                          </div>
                    ...
                    <AnimatePresence mode="wait">
                      {!isGenerated && !loading ? (
                        ...
                        >
                          ...
                          <div className="space-y-2">
                            <p className="text-xl font-bold text-white/40 tracking-tight">System Idle</p>
                            <p className="text-sm text-white/20">Waiting for parameter sync...</p>
                          </div>
                        </motion.div>
                      ) : isGenerated ? (
                        <motion.div
                        ...
                        >
                          ...
                          <div className="flex items-center justify-between px-4">
                            ...
                            <div className="flex items-center gap-4">
                              <Badge className="bg-cyan-500/10 text-cyan-400 border-cyan-500/20 px-4 py-1.5 text-[9px] font-black tracking-widest uppercase">3 Stages Locked</Badge>
                            </div>
                          </div>
                                ...
                                <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-[32px] p-8 hover:bg-white/[0.05] transition-all duration-500 group relative overflow-hidden">
                                  <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 relative z-10">
                                    <div className="space-y-4 flex-1">
                                      <div className="flex items-center gap-4">
                                        <span className={`text-[10px] font-black uppercase tracking-widest text-${step.color === "cyan" ? "cyan" : step.color === "purple" ? "purple" : "emerald"}-400`}>{step.month}</span>
                                      ...
                                      <div className="flex flex-wrap gap-2 mt-4">
                                        {step.skills.map((skill, si) => (
                                          <span key={si} className="text-[10px] font-bold px-3 py-1 rounded-full bg-white/5 border border-white/10 text-white/40">{skill}</span>
                                        ))}
                                      </div>
                                    </div>
                                    <div className="md:w-48 space-y-4">
                                      <p className="text-[9px] font-black text-white/20 uppercase tracking-[0.3em]">Project Milestones</p>
                                      <div className="space-y-2">
                                        {step.projects.map((proj, pi) => (
                                          <div key={pi} className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.02] border border-white/5 group-hover:border-white/10 transition-all">
                                            <div className={`w-1.5 h-1.5 rounded-full bg-${step.color === "cyan" ? "cyan" : step.color === "purple" ? "purple" : "emerald"}-500`} />
                                            <span className="text-[11px] font-bold text-white/60">{proj}</span>
                                          </div>
                                        ))}
                                      </div>
                                    </div>
                ...
                <AnimatePresence>
                  {isGenerated && (
                    <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.8 }} className="mt-32 space-y-12">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-2xl bg-orange-500/10 flex items-center justify-center border border-orange-500/20">
                          <AlertCircle className="w-6 h-6 text-orange-400" />
                        </div>
                        <div>
                          <h3 className="text-3xl font-black tracking-tighter">Gap Analysis</h3>

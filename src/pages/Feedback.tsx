    ...
    <div className="min-h-screen bg-[#050508] text-white selection:bg-cyan-500/30 font-sans relative overflow-hidden">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12 lg:py-20 relative z-10">
          ...
          {!isSubmitted ? (
              ...
              <Card className="bg-black/40 backdrop-blur-3xl border-white/10 rounded-[48px] overflow-hidden shadow-2xl">
                <CardContent className="p-12 space-y-12">
                  <div className="space-y-6 text-center">
                    <label className="text-[10px] font-black text-white/20 uppercase tracking-[0.4em]">Neural Satisfaction Rating</label>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-8">
                    <div className="space-y-2">
                      <label className="text-[10px] font-black text-white/20 uppercase tracking-widest pl-4">Insights & Suggestions</label>
                      <div className="relative group">
                        ...
                        <Textarea
                          ...
                          className="relative bg-black/60 border-white/10 rounded-[32px] min-h-[200px] p-8 text-lg font-medium resize-none focus:border-cyan-500/50 focus:ring-cyan-500/10 transition-all"
                        />
                      </div>
                    </div>
            ...
            >
              ...
              <div className="flex justify-center gap-6">
                 <Link to="/dashboard">
                   <Button variant="outline" className="h-14 px-10 rounded-2xl border-white/10 text-[10px] font-black uppercase tracking-widest hover:bg-white/5">
                     Return to Hub
                   </Button>
                 </Link>
        ...
        <section className="mt-32 grid grid-cols-1 md:grid-cols-2 gap-8">
           <Card className="bg-white/[0.02] border-white/5 rounded-[40px] p-10 space-y-6 group hover:bg-white/[0.04] transition-all cursor-pointer">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-white/40 leading-relaxed font-medium">99.9% uptime across all neural communication nodes.</p>
              </div>
           </Card>
           <Card className="bg-white/[0.02] border-white/5 rounded-[40px] p-10 space-y-6 group hover:bg-white/[0.04] transition-all cursor-pointer">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-white/40 leading-relaxed font-medium">Average feedback integration cycle: 48 neural hours.</p>
              </div>
           </Card>
        </section>
      </main>
